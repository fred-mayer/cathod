<?php
 $data = $this->data;
?>
<div class="catalog_tree<?php if ( $template->auth->isAuthorized ) echo ' admin-module'; ?>" <?php if ( $template->auth->isAdmin ) echo ' idpage="'.$template->idpage.'" idmodule="'.$this->idmodule.'" set_pos="'.$this->set_pos.'"'; ?>>
<h4>Каталог</h4>
<? echo $data ?>
</div>
<?
