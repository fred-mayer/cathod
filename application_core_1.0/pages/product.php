...
$contentHeader = $module->getModule( 'content', array('id'=>2));
$template->setPos( 'header', $contentHeader );

$nav = $module->getModule( 'content', array('id'=>3));
$template->setPos( 'nav', $nav );

$moffers2 = $module->getModule( 'offers', array('isMain'=>1,'isFilter'=>1)); // возвращает класс расширенного модуля
$template->setPos( 'section', $moffers2 );
