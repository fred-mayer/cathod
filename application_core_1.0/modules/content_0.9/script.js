...
$(".content[idcontent]").each(function(){
    $(this).prepend('<div class="btn-toolbar"><div class="btn-group">'+
                        ...
                        '<a class="btn btn-mini" module="admin" action="'+($(this).hasClass('unpublished') ? 'show' : 'hide')+'module" idpage="'+$(this).attr('idpage')+'" idmodule="'+$(this).attr('idmodule')+'" set_pos="'+$(this).attr('set_pos')+'" href="#"><i class="icon-eye-open"></i></a>'+
